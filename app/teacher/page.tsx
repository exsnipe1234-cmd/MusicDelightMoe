...
export default function TeacherPortal() {
  ...
  return (
    <main className="portalShell">
      ...
      <nav className="mobilePortalNav" aria-label="Teacher portal sections"><a href="#today-schedule">Today</a><a href="#upcoming-lessons">Upcoming</a><button onClick={() => router.refresh()}>Refresh</button></nav>
