...
export default function TeacherPortal() {
  ...
  return (
    <main className="portalShell">
      ...
      <nav className="mobilePortalNav" aria-label="Teacher portal sections">
        <a href="#today-schedule">Today</a>
      ...
      <section className="heroGrid">
        <article className="nextCard">
          ...
          {nextLesson ? (
            ...
            <div className="emptyNext">
              <CalendarDays size={34} />
              <strong>No upcoming lessons</strong>
              <span>Your next assigned lesson will appear here.</span>
            </div>
          )}
        </article>
            ...
            {todayLessons.length ? (
              todayLessons.map((lesson, index) => (
                ...
                >
                  ...
                  <div className="lessonDetails" style={{ overflow: 'visible' }}>
                    <strong
                    ...
                    >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        style={{ color: 'inherit', opacity: 0.65, display: 'flex', flexShrink: 0 }}
                        title="Open in Google Maps"
                      >
                        <MapPin size={10} />
                      </a>
              ...
              <div className="emptySchedule">
                ...
                <strong>No lessons today</strong>
                <span>Enjoy the open space in your schedule.</span>
              </div>
            )}
          </div>
        </article>
        <aside className="quickCard">
          ...
          <button className="urgentAction" onClick={() => setRequestOpen(true)}>
            ...
            <div>
              ...
              <small>Send a request for affected lessons</small>
            </div>
          ...
          <button onClick={scrollToSchedule}>
            ...
            <div>
              <strong>View today&apos;s timetable</strong>
              <small>Jump to your lesson list</small>
            </div>
            <ChevronRight size={18} />
          </button>
          <button onClick={() => router.refresh()}>
            ...
            <div>
              ...
              <small>Check for the latest changes</small>
            </div>
            <ChevronRight size={18} />
          </button>
        </aside>
        ...
        <div className="requestList">
          {requests.length ? (
                ...
                <div>
                  <span>
                    {new Intl.DateTimeFormat('en-SG', {
                      ...
                      month: 'short',
                      year: 'numeric',
                    }).format(parseLocalDate(request.start_date))}
                    {request.end_date !== request.start_date
                      ? ` – ${new Intl.DateTimeFormat('en-SG', { day: 'numeric', month: 'short' }).format(parseLocalDate(request.end_date))}`
                      : ''}
                  </span>
                  <strong>{request.reason}</strong>
                  <small>
                    {request.affected_lessons?.length ?? 0} affected lesson
            ...
            <div className="emptyRequests">
              ...
              <span>Use “Unable to attend” when you cannot make an assigned lesson.</span>
            </div>
          )}
        </div>
      </section>

      <section className="upcomingCard" id="upcoming-lessons">
        <div className="sectionHeading">
          <div>
            <p>UPCOMING</p>
            ...
            <article key={lesson.id}>
              <span>
                {new Intl.DateTimeFormat('en-SG', {
                  ...
                  day: 'numeric',
                  month: 'short',
                }).format(parseLocalDate(lesson.lesson_date))}
              </span>
      ...
      <style jsx>{`
        ...
        .brand > span {
          ...
          display: grid;
          place-items: center;
          background: linear-gradient(135deg, #7666ee, #4f3bbd);
          box-shadow: 0 12px 30px rgba(103, 86, 225, 0.28);
        }
        .brand p,
        .sectionHeading p,
        .welcome p,
        .requestModal header p {
          margin: 0 0 4px;
          color: #8c7cf4;
          font-size: 10px;
          font-weight: 900;
        ...
        .nextCard:after {
          ...
          right: -90px;
          top: -140px;
          background: radial-gradient(circle, rgba(112, 91, 231, 0.24), transparent 68%);
          pointer-events: none;
        }
        .cardLabel {
          display: flex;
        ...
        .timeBadge {
          ...
          gap: 3px;
          background: linear-gradient(145deg, #7766ec, #4c39b9);
          box-shadow: 0 18px 40px rgba(91, 70, 205, 0.3);
        }
        .timeBadge strong {
          font-size: 27px;
        }
        ...
        .barColumn i {
          ...
          min-height: 8px;
          border-radius: 8px;
          background: linear-gradient(180deg, #8170f2, #5140bd);
        ...
        .statGrid article > span {
          color: #8794aa;
          font-size: 12px;
        }
        .statGrid article > strong {
          font-size: 27px;
          grid-column: 2;
        }
        .statGrid article > small {
          color: #69768e;
          grid-column: 2;
        }
        .statIcon {
        ...
        .statIcon.purple {
          background: rgba(129, 112, 242, 0.13);
          color: #a99cff;
        }
        .statIcon.blue {
        ...
        .todayLesson {
          display: grid;
          grid-template-columns: 20px 78px 1fr auto;
          gap: 13px;
          min-height: 78px;
        }
        .timeline {
        ...
        .timeline > i {
          width: 11px;
          height: 11px;
          border: 3px solid #7c6deb;
          border-radius: 50%;
          background: #11182a;
        }
        .timeline span {
          width: 1px;
          background: rgba(129, 112, 242, 0.22);
        }
        .lessonTime,
        .lessonDetails {
          display: grid;
        ...
        .quickCard button div {
          display: grid;
          gap: 3px;
        }
        .quickCard button small {
          color: #748198;
        }
        .quickIcon {
          width: 38px;
        ...
        .requestList > article > div:first-child {
          display: grid;
          gap: 4px;
        }
        .requestList span,
        ...
        .upcomingGrid article > span {
          color: #9385ee;
          font-size: 10px;
          font-weight: 800;
          text-transform: uppercase;
        }
        .upcomingGrid article small {
          color: #8190a8;
        }
        .upcomingGrid article p {
          display: flex;
          align-items: center;
          gap: 5px;
          margin: 5px 0 0;
        ...
        .affected article > div {
          display: grid;
          gap: 3px;
        }
        .affected article span,
        .affected article p {
          color: #8190a8;
          font-size: 11px;
          margin: 0;
        ...
        .submit {
          border: 0;
          background: linear-gradient(135deg, #7666ee, #5742ca);
          color: white;
          font-weight: 800;
        }
        .submit:disabled {
        ...
        @media (max-width: 620px) {
          ...
          .todayLesson {
            grid-template-columns: 16px 65px 1fr;
          }
          .todayLesson em {
            display: none;
          }
