  ...
  return (
    <>
      <header className="adminMobileBar">
        <div className="adminBrand compact">
          <div className="adminBrandMark">
            <School size={20} />
          </div>
          <strong>MOE Calendar</strong>
        </div>
        <button onClick={() => setMobileOpen((value) => !value)} aria-label="Open navigation">
          {mobileOpen ? <X /> : <Menu />}
        </button>
      </header>
      {mobileOpen && (
        <button
          className="adminMenuBackdrop"
      ...
      <aside className={mobileOpen ? 'adminSidebar mobileOpen' : 'adminSidebar'}>
        ...
        <div className="adminSidebarFooter">
          ...
          <button className="adminLogout" onClick={logout} disabled={signingOut}>
            <LogOut size={16} />
      ...
      <style jsx global>{`
        ...
        .adminBrandMark {
          ...
          box-shadow: 0 12px 30px rgba(83, 69, 230, 0.3);
        }
        .adminBrand > div:last-child {
          display: grid;
          gap: 2px;
        }
        .adminBrand strong {
        ...
        .adminNavLink.active {
          color: #fff !important;
          background: linear-gradient(90deg, rgba(120, 87, 255, 0.23), rgba(46, 212, 199, 0.07));
        }
        .adminNavLink.active {
        ...
        .adminSidebarFooter > div {
          display: grid;
          gap: 4px;
          padding: 0 4px;
        }
        .adminSidebarFooter span {
          color: #6f7c95;
          font-size: 9px;
          font-weight: 900;
        ...
        @media (max-width: 900px) {
          ...
          .adminMobileBar .adminBrand {
            padding: 0;
          }
          .adminMobileBar .adminBrandMark {
            width: 38px;
            height: 38px;
          }
          .adminMobileBar button {
            width: 40px;
            height: 40px;
            display: grid;
            place-items: center;
